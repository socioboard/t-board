...
public class FragmentTimeLine extends Fragment implements OnScrollListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if (MainSingleTon.loadedtweets.size() == 0) {
			...
			FetchTimelineLatestPaged(MainSingleTon.loadedtweets.get(0)
					.getTweetId());
		...
		timer.schedule(new TimerTask() {
			...
			public void run() {
				...
				FragmentTimeLine.this.getActivity().runOnUiThread(
						new Runnable() {
			...
			public void onRefresh() {
				...
				if (isAlreadyScrolling) {
					...
					if (MainSingleTon.loadedtweets.size() == 0) {
						...
						FetchTimelineLatestPaged(MainSingleTon.loadedtweets
								.get(0).getTweetId());
...
//	}
	...
	private void addFooterView() {
		...
		LayoutInflater inflater = FragmentTimeLine.this.getActivity()
				.getLayoutInflater();
	...
	protected void parseJsonResult(String jsonResult) {
		...
		myprint("parseJsonResult  FragmentTimeLine");
	...
	void myToastS(final String toastMsg) {
		...
		Toast.makeText(FragmentTimeLine.this.getActivity(), toastMsg,
