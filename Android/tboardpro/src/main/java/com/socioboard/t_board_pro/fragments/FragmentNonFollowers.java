...
public class FragmentNonFollowers extends Fragment implements OnScrollListener
{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		MainSingleTon.mixpanelAPI.track("Fragment NonFollowers oncreate called");
	...
	protected void parseJsonResultPaged(String jsonResult) {
		...
		myprint("parseJsonResult  FragmentNonFollowers323");
			...
			for (int i = 0; i < jsonArray.length(); ++i) {
				...
				getActivity().runOnUiThread(new Runnable() {
					...
					public void run() {
						...
						if (FragmentNonFollowers.this.getActivity() != null) {
	...
	protected void parseJsonResult(String jsonResult) {
		...
		myprint("parseJsonResult  FragmentNonFollowers121");
			...
			handler.post(new Runnable() {
				...
				public void run() {
					...
					if (FragmentNonFollowers.this.getActivity() != null) {
						...
						toFollowingAdp = new ToFollowingAdapter(getActivity(),	nonFollowers, FragmentNonFollowers.this
										.getActivity());
