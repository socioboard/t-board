...
public class FragmentOverlappingFollowings extends Fragment implements
		OnScrollListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		MainSingleTon.mixpanelAPI.track("Fragment OverlappingFollowings oncreate called");
					...
					public void onSuccess(String jsonResult) {
						...
						aActivity.runOnUiThread(new Runnable() {
							...
							public void run() {
								...
								textView3Counts
										.setText("Overlapping followings :   "
	...
	void showTexts() {
		...
		textView1UserName.setText(MainSingleTon.fullUserDetailModel
				.getUserName());

		textView1Name.setText(MainSingleTon.fullUserDetailModel.getFullName());

		TextView01Followings.setText(MainSingleTon.fullUserDetailModel
				.getNoToFollowing());

		TextView0FollowedBy.setText(MainSingleTon.fullUserDetailModel
				.getNoFollowers());

		imageLoader.DisplayImage(
				MainSingleTon.fullUserDetailModel.getUserImagerUrl(),
				profile_pic);
	...
	protected void parseJsonResultPaged(String jsonResult) {
		...
		myprint("parseJsonResult  FragmentOverlappingFollowings1111");
			...
			for (int i = 0; i < jsonArray.length(); ++i) {
				...
				getActivity().runOnUiThread(new Runnable() {
					...
					public void run() {
						...
						if (FragmentOverlappingFollowings.this.getActivity() != null) {
	...
	protected void parseJsonResult(String jsonResult) {
		...
		myprint("parseJsonResult  FragmentOverlappingFollowings323223");
				...
				public void run() {
					...
					if (FragmentOverlappingFollowings.this.getActivity() != null) {
						...
						toFollowingAdp = new ToFollowingAdapter(getActivity(),
								ovlpFollwers,
								FragmentOverlappingFollowings.this
										.getActivity());
