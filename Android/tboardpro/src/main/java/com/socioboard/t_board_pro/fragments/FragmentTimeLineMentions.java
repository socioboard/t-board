...
public class FragmentTimeLineMentions extends Fragment implements
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		listView.setOnScrollListener(FragmentTimeLineMentions.this);

		twtAdpr = new TweetsAdapter(loadedtweets,
				FragmentTimeLineMentions.this.getActivity());
		...
		timer.schedule(new TimerTask() {
			...
			public void run() {
				...
				FragmentTimeLineMentions.this.getActivity().runOnUiThread(
						new Runnable() {
...
//	}
	...
	private void addFooterView() {
		...
		LayoutInflater inflater = FragmentTimeLineMentions.this.getActivity()
				.getLayoutInflater();
	...
	public void FetchTimeline() {
		...
		twitterTimeLineRequest.executeThisRequest(
				MainSingleTon.mentions_timeline, peramPairs);
	...
	protected void parseJsonResult(String jsonResult) {
		...
		myprint("parseJsonResult  FragmentTimeLineMentions");
		...
		handler.post(new Runnable() {
			...
			public void run() {
				...
				if (FragmentTimeLineMentions.this.getActivity() != null) {
			...
			for (int i = 0; i < jsonArray.length(); ++i) {
				...
				try {
					...
					if (jsonObjectk2.has("extended_entities")) {
						...
						System.out.println("***** Noooooo jsonObjectk2.has(Const.media) *****");
	...
	void myToastS(final String toastMsg) {
		...
		Toast.makeText(FragmentTimeLineMentions.this.getActivity(), toastMsg,
