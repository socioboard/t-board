...
public class FragmentBlackList extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        MainSingleTon.mixpanelAPI.track("FragmentBlackList oncreate called");
        view= inflater.inflate(R.layout.fragment_fragment_black_list, container, false);
        LoadAd();
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                if(MainSingleTon.BlackListdatas.size()>0)
                {
                    ...
                    activeMyOrdersAdopter=new ActiveMyOrdersAdopter(getActivity(),MainSingleTon.BlackListdatas);
                    ...
                    Toast.makeText(getActivity(), "No Item in Black List", Toast.LENGTH_SHORT).show();
                    reloutProgress1.setVisibility(View.GONE);
                }
            }
        }, 250);
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            holder.textRemove.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    reloutProgress1.setVisibility(View.VISIBLE);
                    boolean aaa= tboardproLocalData.deleteblackListData(ac[0],MainSingleTon.currentUserModel.getUserid());
