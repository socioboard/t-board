...
public class TwtboardproLocalData extends SQLiteOpenHelper {
	...
	public TwtboardproLocalData(Context context) {
	...
	public void CreateTable() {
		...
		String querry = "CREATE TABLE IF NOT EXISTS " + table_name + "("
				...
				+ KEY_Userimage + " TEXT,"
				+ KEY_Username + " TEXT," 
				+ KEY_UserAcessToken + " TEXT," + KEY_UserSecretKey + " TEXT)";
	...
	public ModelUserDatas getUserData(String userId) {
		...
		String query = "SELECT * FROM " + table_name + " WHERE " + KEY_UserID + " = '" + userId + "'";
	...
	public void updateUserData(ModelUserDatas modelUserDatas) {
		...
		String updateQuery = "UPDATE " + table_name + " SET " 
				...
				+ KEY_UserSecretKey + " = '" + modelUserDatas.getUsersecretKey() + "' , " 
